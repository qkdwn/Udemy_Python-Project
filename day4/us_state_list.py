...
# print(states_of_america[]) # [] 리스트와 상관있다고 생각하면 된다.
                             # -1을 입력하면 맨 뒤에서 부터 시작. 즉 Hawaii가 나옴
states_of_america[1] = "Pencilvania" # 리스트 이름 변경하는 방법

states_of_america.append("Angelaland") #append 리스트 맨 마지막에 추가
                                       #extend의 경우 여러 개의 값을 맨 마지막에 추가 가능
